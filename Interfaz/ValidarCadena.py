...
class ValidarCadena(tk.Toplevel):
    def __init__(self):
        ...
        button_1 = Button(
            ...
            command=lambda: resolver_afn_seleccionado(self),
        )
...
def resolver_afn_seleccionado(self):
    # Obtener el índice del AFN seleccionado en el listbox
    ...
    if selected_index:
        ...
        # Resolver el AFN y obtener los resultados
        resultados = Clases.AFN.generar_cadena_ejemplo(afn)
...
def ComprobarCadena(self, cadena):
    ...
    if selected_index:
        # Obtener el AFN correspondiente al índice seleccionado
        afn = afn_registrados[selected_index[0]]
        resultados = Clases.AFN.comprobar_cadena_afn(afn, cadena)
