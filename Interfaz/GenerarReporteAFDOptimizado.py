...
import Interfaz.GenerarReporteAFDOptimizado
...
class GenerarReporteAFDOptimizado(tk.Toplevel):
    def __init__(self):
        super().__init__()
        ...
        label1 = Label(
        self,
        text="AFDOptimizado Registrados",
...
def cargarAFDOptimizado(self):
    afd_registrados = Clases.AFDOptimizado.listaAFDOptimizado()
...
def generarPDF(self):
    ...
    if selected_index:
        # Obtener el AFDOptimizado correspondiente al índice seleccionado
        afd = afd_registrados[selected_index[0]]
        
        Clases.ReporteAFDOptimizado.generarReporteAFDOptimizado(afd.estados, afd.estados_aceptacion,afd.transiciones,afd.transicionesN,afd.estado_inicial,afd.nombre,afd)
