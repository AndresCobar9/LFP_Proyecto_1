...
class ValidarCadenaAFD(tk.Toplevel):
    def __init__(self):
        ...
        button_1 = Button(
            ...
            command=lambda: resolver_afd_seleccionado(self),
        )
...
def resolver_afd_seleccionado(self):
    # Obtener el índice del AFD seleccionado en el listbox
    ...
    if selected_index:
        ...
        # Resolver el AFD y obtener los resultados
        resultados = Clases.AFD.generar_cadena_ejemplo(afd)
                        
        # Mostrar los resultados en una ventana de mensaje
        messagebox.showinfo("Resultados", "Cadena de Resultado: " + resultados)
...
def ComprobarCadena(self, cadena):
    ...
    if selected_index:
        # Obtener el AFD correspondiente al índice seleccionado
        afd = afd_registrados[selected_index[0]]
        resultados = Clases.AFD.comprobar_cadena_afd(afd, cadena)
